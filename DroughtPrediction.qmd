---
title: "Drought Prediction Final Project"
author: "Mason Zimmer"
format: html
editor: visual
---
...
1.  Select State
2.  Select Watershed
3.  Return a message detailing if drought is likely
...
![](images/clipboard-620318681.png)
...
After completing the app and reviewing the data we can see significant levels of drought likely throughout the western United States. This year we can predict that upstream dams will need to be opened in order to secure the safety of the living ecosystems they have been choking. Furthermore, we will likely see a weak harvest and recreation season, as farmers, boaters, and anglers alike will be without their essential resource, water. As dams open and the streams refill with life, we must learn from years like this. It is everyone's job to petition for national intervention to ensure that our aquatic circulatory system does not evaporate away. There are millions of lives on the line (not only human), we owe it to the species we have impacted to save them from our mistakes.
...
\[1\] Posit, “Posit AI,” *Posit*. https://posit.co/products/ai

\[2\] “Western US SNOTEL Snow/Precipitation Update report,” *NWCC Apps*. https://wcc.sc.egov.usda.gov/reports/UpdateReport.html?report=Western+US
